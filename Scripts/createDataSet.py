...
class createDataSet:
    def __init__(self,ratecsv, dataset, num_input_rows, num_output_rows):
...
if __name__ == "__main__":
    ...
    dataset = sys.argv[2]
    print(dataset)
    num_input_rows = int(sys.argv[3])
    num_output_rows = int(sys.argv[4])
    
    
    grps  = createDataSet(ratecsv, dataset, num_input_rows, num_output_rows)
